...
export default function AlertFeed({
  ...
  return (
    <div className="flex flex-col h-full bg-slate-950/80 backdrop-blur-md rounded-2xl border border-slate-800 shadow-2xl overflow-hidden">
      ...
      <div className="p-4 border-b border-slate-800/80 space-y-3">
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400 font-mono">EAS Broadcast & Field Telemetry</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1.5">
            ...
            >
              {autoSimulate ? <Pause className="w-3 h-3 text-emerald-400" /> : <Play className="w-3 h-3 text-slate-400" />}
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-slate-900/90 text-slate-200 text-xs pl-8 pr-3 py-1.5 rounded-lg border border-slate-800 focus:outline-none focus:border-rose-500/60 transition-colors placeholder:text-slate-600 font-sans"
          />
        </div>
              ...
              <div
                ...
                className={`p-3 rounded-xl border transition-all cursor-pointer group hover:scale-[1.01] ${
                  isCritical
                    ...
                    : 'bg-slate-900/50 border-slate-800 hover:border-sky-500/50 hover:bg-slate-900/80'
                }`}
              >
                {/* Header Row */}
                ...
                {/* Title */}
                <h3 className="text-xs font-bold text-slate-100 group-hover:text-rose-300 transition-colors leading-snug">
                  {alert.title}
                </h3>
