      ...
      <div className="relative w-full max-w-xl bg-slate-900 border border-slate-700/80 rounded-2xl shadow-2xl overflow-hidden my-6">
        ...
        {submitted ? (
          <div className="p-8 text-center space-y-3">
            ...
            <h3 className="text-lg font-bold text-white">Status Broadcasted Successfully</h3>
          ...
          <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4">
            ...
            <div>
              ...
              {coords && (
                <div className="mb-2 p-2 rounded-lg bg-slate-950 border border-slate-800 flex items-center justify-between text-xs font-mono text-slate-300">
                  <div className="flex items-center gap-1.5 text-emerald-400">
                    <MapPin className="w-3.5 h-3.5" />
                    <span>LAT: {coords.lat}, LNG: {coords.lng}</span>
                  </div>
                  <span className="text-slate-500 text-[10px]">{coords.accuracy}</span>
                </div>
              )}
              ...
              <input
                ...
                className="w-full bg-slate-950 text-slate-200 text-xs px-3 py-2 rounded-lg border border-slate-800 focus:outline-none focus:border-sky-500"
              />
            </div>
